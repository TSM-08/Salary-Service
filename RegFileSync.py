...
proc_name = 'RegFileSync'
procedure = 'call docflow.prc_regfile_stsync(%s)'
...
if __name__ == "__main__":
    log_folder = sys.argv[1] if len(sys.argv) > 1 else ''
    ini_folder = sys.argv[2] if len(sys.argv) > 2 else ''
