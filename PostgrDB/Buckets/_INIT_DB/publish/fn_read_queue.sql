-- FUNCTION: buckets.fn_read_queue(character varying, integer)

-- DROP FUNCTION buckets.fn_read_queue(character varying, integer);

CREATE OR REPLACE FUNCTION buckets.fn_read_queue(
...
ALTER FUNCTION buckets.fn_read_queue(character varying, integer)
    OWNER TO mgrpoc;

COMMENT ON FUNCTION buckets.fn_read_queue(character varying, integer)
