-- Table: gpibase.transtatus_log

-- DROP TABLE gpibase.transtatus_log;

CREATE TABLE gpibase.transtatus_log
(
    ...
    CONSTRAINT transtatus_log_pk PRIMARY KEY (trn_id, trn_cdate)
)

TABLESPACE pg_default;

ALTER TABLE gpibase.transtatus_log
    OWNER to postgres;
