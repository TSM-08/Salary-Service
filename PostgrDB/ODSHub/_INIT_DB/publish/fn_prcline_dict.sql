-- FUNCTION: docflow.fn_prcline_dict(bigint)

-- DROP FUNCTION docflow.fn_prcline_dict(bigint);

CREATE OR REPLACE FUNCTION docflow.fn_prcline_dict(
	p_id bigint)
...
declare 
   v_json json;
begin 
   select line_detail into v_json
...
ALTER FUNCTION docflow.fn_prcline_dict(bigint)
    OWNER TO mgrpoc;
